...
\begin{abstract}
    ...
    In this paper, we propose a supervised-learning regression model able to capture accurate global routing behaviours, through which a congestion prediction model is trained to improve the global routing.
