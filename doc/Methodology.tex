...
\begin{figure}[htbp]
	\centerline{\includegraphics[height=1.2in, width=1.4in]{fdpin}}
...
\begin{figure}[htbp]
	\centerline{\includegraphics[height=1.2in, width=1.4in]{fdnet}}
...
\subsection{Prediction Model Embedded Routability optimisation}
